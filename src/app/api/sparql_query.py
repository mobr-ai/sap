...
async def get_sync_data():
    ...
    with tracer.start_as_current_span("get_sync_data") as span:
        try:
            return QueryResponse(results={"results":{"head":{"vars":["currentCardanoHeight","capBlockNum","count"]},"results":{"bindings":[{"currentCardanoHeight":{"datatype":"http://www.w3.org/2001/XMLSchema#int","type":"literal","value":"10"},"capBlockNum":{"datatype":"http://www.w3.org/2001/XMLSchema#decimal","type":"literal","value":"10.0"},"count":{"datatype":"http://www.w3.org/2001/XMLSchema#int","type":"literal","value":"10"}}]},"meta":{"query-time-ms":632,"result-size-total":1}}})
